...
DROP SEQUENCE IF EXISTS "music".public."artists_id_seq" CASCADE;
CREATE SEQUENCE "music".public."artists_id_seq"
    START WITH 275
    INCREMENT BY 1;

DROP TABLE IF EXISTS "music".public."artists" CASCADE;
CREATE TABLE "music".public."artists" (
    "id" INTEGER DEFAULT "music".public."artists_id_seq".NEXTVAL NOT NULL,
    "name" TEXT,
    CONSTRAINT "pk_artists" PRIMARY KEY ("id")
);

DROP SEQUENCE IF EXISTS "music".public."albums_id_seq" CASCADE;
CREATE SEQUENCE "music".public."albums_id_seq"
    START WITH 347
    INCREMENT BY 1;

DROP TABLE IF EXISTS "music".public."albums" CASCADE;
CREATE TABLE "music".public."albums" (
    "id" INTEGER DEFAULT "music".public."albums_id_seq".NEXTVAL NOT NULL,
    "title" TEXT NOT NULL,
    "artist_id" INTEGER NOT NULL,
    CONSTRAINT "pk_albums" PRIMARY KEY ("id"),
    CONSTRAINT "fk_album_artist_id" FOREIGN KEY ("artist_id") REFERENCES "music".public."artists"("id")
);

DROP SEQUENCE IF EXISTS "music".public."genres_id_seq" CASCADE;
CREATE SEQUENCE "music".public."genres_id_seq"
    START WITH 25
    INCREMENT BY 1;

DROP TABLE IF EXISTS "music".public."genres" CASCADE;
CREATE TABLE "music".public."genres" (
    "id" INTEGER DEFAULT "music".public."genres_id_seq".NEXTVAL NOT NULL,
    "name" TEXT,
    CONSTRAINT "pk_genres" PRIMARY KEY ("id")
);

DROP SEQUENCE IF EXISTS "music".public."mediatypes_id_seq" CASCADE;
CREATE SEQUENCE IF NOT EXISTS "music".public."mediatypes_id_seq"
    START WITH 5
    INCREMENT BY 1;

DROP TABLE IF EXISTS "music".public."media_types" CASCADE;
CREATE TABLE "music".public."media_types" (
    "id" INTEGER DEFAULT "music".public."mediatypes_id_seq".NEXTVAL NOT NULL,
    "name" TEXT,
    CONSTRAINT "pk_media_types" PRIMARY KEY ("id")
);

DROP SEQUENCE IF EXISTS "music".public."tracks_id_seq" CASCADE;
CREATE SEQUENCE "music".public."tracks_id_seq"
    START WITH 3503
    INCREMENT BY 1;

DROP TABLE IF EXISTS "music".public."tracks" CASCADE;
CREATE TABLE "music".public."tracks" (
    "id" INTEGER DEFAULT "music".public."tracks_id_seq".NEXTVAL NOT NULL,
    "name" TEXT NOT NULL,
    "album_id" INTEGER,
    ...
    CONSTRAINT "fk_track_album_id" FOREIGN KEY ("album_id") REFERENCES "music".public."albums"("id"),
    CONSTRAINT "fk_track_genre_id" FOREIGN KEY ("genre_id") REFERENCES "music".public."genres"("id"),
    CONSTRAINT "fk_track_media_type_id" FOREIGN KEY ("media_type_id") REFERENCES "music".public."media_types"("id")
);

INSERT INTO "music".public."genres" ("id", "name") VALUES
  (1, 'Rock'),
  (2, 'Jazz'),
  (3, 'Metal'),
  (4, 'Alternative & Punk'),
...
INSERT INTO "music".public."media_types" ("id", "name") VALUES
  (1, 'MPEG audio file'),
...
INSERT INTO "music".public."artists" ("id", "name") VALUES
  (1, 'AC/DC'),
  (2, 'Accept'),
  (3, 'Aerosmith'),
  (4, 'Alanis Morissette'),
...
INSERT INTO "music".public."albums" ("id", "title", "artist_id") VALUES
  ...
  (332, 'The Ultimate Relexation albums', 262),
...
INSERT INTO "music".public."tracks" ("id", "name", "album_id", "media_type_id", "genre_id", "composer", "milliseconds", "bytes", "unit_price") VALUES
  ...
  (1159, 'Dust '' Bones', 91, 2, 1, '', 298374, 5053742, 0.99),
  ...
  (1211, 'Hallowed Be Thy Name (Live) [Non Album Bonus tracks]', 94, 2, 1, '', 431262, 7205816, 0.99),
  ...
  (3402, 'Band Members Discuss trackss from Revelations', 271, 3, 23, '', 294294, 61118891, 0.99),
